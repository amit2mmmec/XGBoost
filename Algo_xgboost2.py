...
# ==========================================
# 5. THE PNL SIMULATOR (WITH STRICT RISK MANAGEMENT)
# ==========================================
print("\nSimulating Real-World PnL and Equity Curve...")
...
# Trading constraints
SLIPPAGE_AND_BROKERAGE_POINTS = 1.5  # Points lost per trade
MAX_TRADES_PER_DAY = 5               # Forced shutdown limit
...
for i in range(len(merged_df)):
    ...
    if in_trade:
        ...
        # Check Time Timeout (30 mins max)
        elif i >= timeout_bar:
    ...
    # If NOT in trade, check for Buy Signal, subject to MAX_TRADES limit
